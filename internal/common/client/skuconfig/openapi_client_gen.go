...
type ClientInterface interface {
	// GetSKU request
	GetSKU(ctx context.Context, params *GetSKUParams, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) GetSKU(ctx context.Context, params *GetSKUParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetSKURequest(c.Server, params)
	if err != nil {
		return nil, err
	}
...
func NewGetSKURequest(server string, params *GetSKUParams) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	// GetSKU request
	GetSKUWithResponse(ctx context.Context, params *GetSKUParams, reqEditors ...RequestEditorFn) (*GetSKUResponse, error)
}
...
func (c *ClientWithResponses) GetSKUWithResponse(ctx context.Context, params *GetSKUParams, reqEditors ...RequestEditorFn) (*GetSKUResponse, error) {
	rsp, err := c.GetSKU(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
